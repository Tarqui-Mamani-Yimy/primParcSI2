import "./chunk-MSBMWLX3.js";
import {
  getDOM
} from "./chunk-IHPK2TOU.js";
import {
  ApplicationRef,
  ChangeDetectorRef,
  DestroyRef,
  ...
  ɵɵlistener
} from "./chunk-25OYE6WA.js";
import "./chunk-ANIDJVG3.js";
import {
  forkJoin
} from "./chunk-KRLIMMWB.js";
import {
  Subject,
  Subscription,
  __publicField,
  from,
  map
} from "./chunk-RTTKC7H4.js";

// node_modules/.pnpm/@angular+forms@22.1.4_@angular+common@22.1.4_@angular+core@22.1.4_@angular+compiler@22._967ac53914c1bab15eee6943b074d0cd/node_modules/@angular/forms/fesm2022/forms.mjs
...
function minLengthValidator(minLength) {
  return (control) => {
    var _a;
    const length = ((_a = control.value) == null ? void 0 : _a.length) ?? lengthOrSize(control.value);
...
var AbstractControlDirective = class {
  ...
  reset(value = void 0) {
    var _a;
    (_a = this.control) == null ? void 0 : _a.reset(value);
  }
...
var AbstractControl = class {
  constructor(validators, asyncValidators) {
    ...
    __publicField(this, "_hasRequired", signal(false, ...ngDevMode ? [{
  ...
  markAsTouched(opts = {}) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a.markAsTouched({
        ...opts,
        sourceControl
      });
    }
  ...
  markAsUntouched(opts = {}) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a._updateTouched(opts, sourceControl);
    }
    if (changed && opts.emitEvent !== false) {
  ...
  markAsDirty(opts = {}) {
    ...
    const sourceControl = opts.sourceControl ?? this;
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a.markAsDirty({
        ...opts,
        sourceControl
      });
    }
  ...
  markAsPristine(opts = {}) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a._updatePristine(opts, sourceControl);
    }
    if (changed && opts.emitEvent !== false) {
  ...
  markAsPending(opts = {}) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a.markAsPending({
        ...opts,
        sourceControl
      });
    }
  ...
  _updateAncestors(opts, sourceControl) {
    var _a, _b, _c;
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a.updateValueAndValidity(opts);
      if (!opts.skipPristineCheck) {
        (_b = this._parent) == null ? void 0 : _b._updatePristine({}, sourceControl);
      }
  ...
  updateValueAndValidity(opts = {}) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a.updateValueAndValidity({
        ...opts,
        sourceControl
      });
    }
  ...
  _cancelExistingSubscription() {
    ...
    if (this._asyncValidationSubscription) {
      ...
      const shouldHaveEmitted = (((_a = this._hasOwnPendingAsyncValidator) == null ? void 0 : _a.emitEvent) || ((_b = this._hasOwnPendingAsyncValidator) == null ? void 0 : _b.shouldHaveEmitted)) ?? false;
      this._hasOwnPendingAsyncValidator = null;
  ...
  _updatePristine(opts, changedControl) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a._updatePristine(opts, changedControl);
    }
    if (changed) {
  ...
  _updateTouched(opts = {}, changedControl) {
    ...
    if (!opts.onlySelf) {
      (_a = this._parent) == null ? void 0 : _a._updateTouched(opts, changedControl);
    }
  }
  ...
  _parentMarkedDirty(onlySelf) {
    var _a;
    return !onlySelf && !!((_a = this._parent) == null ? void 0 : _a.dirty) && !this._parent._anyControlsDirty();
  }
  _find(name) {
    return null;
  }
...
var _AbstractValidatorDirective = class _AbstractValidatorDirective {
  ...
  ngOnChanges(changes) {
    ...
    if (this.inputName in changes) {
      ...
      (_a = this._onChange) == null ? void 0 : _a.call(this);
    }
  }
  validate(control) {
...
function cleanUpControl(control, dir, validateControlPresenceOnChange = true) {
  ...
  (_a = dir == null ? void 0 : dir.valueAccessor) == null ? void 0 : _a.registerOnChange(noop);
  (_b = dir == null ? void 0 : dir.valueAccessor) == null ? void 0 : _b.registerOnTouched(noop);
...
var NgControl = class extends AbstractControlDirective {
  constructor(injector, renderer, rawValueAccessors) {
    ...
    __publicField(this, "isCustomControlBased", false);
    __publicField(this, "userOnReset");
    __publicField(this, "resetSubscription");
    __publicField(this, "isNativeFormElement", false);
    __publicField(this, "rawValueAccessors");
    __publicField(this, "_selectedValueAccessor", null);
    __publicField(this, "parseErrorsValidator", null);
    __publicField(this, "renderer");
    __publicField(this, "injector");
    __publicField(this, "requiredValidatorViaDi");
    __publicField(this, "subscription");
    __publicField(this, "customControlBindings", null);
    this.injector = injector;
    this.renderer = renderer;
    this.rawValueAccessors = rawValueAccessors;
    (_b = (_a = this.injector) == null ? void 0 : _a.get(DestroyRef)) == null ? void 0 : _b.onDestroy(() => {
      var _a2;
  ...
  set onReset(callback) {
    ...
    (_a = this.resetSubscription) == null ? void 0 : _a.unsubscribe();
    ...
    if (this.control) {
      this.resetSubscription = this.control.events.subscribe((event) => {
        ...
        if (event instanceof FormResetEvent && this.control) {
          (_a2 = this.userOnReset) == null ? void 0 : _a2.call(this, this.control.value);
        }
      });
      (_b = this.subscription) == null ? void 0 : _b.add(this.resetSubscription);
    }
  }
  get selectedValueAccessor() {
    return this._selectedValueAccessor ?? (this._selectedValueAccessor = selectValueAccessor(this, this.rawValueAccessors));
  }
  setupCustomControl() {
    var _a, _b, _c;
    (_a = this.subscription) == null ? void 0 : _a.unsubscribe();
    const cdr = (_b = this.injector) == null ? void 0 : _b.get(ChangeDetectorRef);
    if (!this.control || !cdr) {
      return;
    }
    ...
    (_c = this.resetSubscription) == null ? void 0 : _c.unsubscribe();
    this.resetSubscription = void 0;
    if (this.userOnReset) {
      this.resetSubscription = this.control.events.subscribe((event) => {
        var _a2;
  ...
  ngControlCreate(host) {
    var _a, _b;
    const hasNgNoCva = (_b = (_a = host.nativeElement).hasAttribute) == null ? void 0 : _b.call(_a, "ngNoCva");
    ...
    host.listenToCustomControlModel((value) => {
      var _a2, _b2;
      (_a2 = this.control) == null ? void 0 : _a2.setValue(value, {
        emitModelToViewChange: false
      });
      (_b2 = this.control) == null ? void 0 : _b2.markAsDirty();
      this.viewToModelUpdate(value);
    });
    host.listenToCustomControlOutput("touch", () => {
      var _a2;
      (_a2 = this.control) == null ? void 0 : _a2.markAsTouched();
    });
  ...
  get isRequired() {
    var _a, _b;
    return (((_a = this.requiredValidatorViaDi) == null ? void 0 : _a._enabled) || ((_b = this.control) == null ? void 0 : _b._hasRequired())) ?? false;
  }
  ...
  setParseErrorSource(parseErrors) {
    ...
    effect(() => {
      ...
      (_a = this.control) == null ? void 0 : _a.updateValueAndValidity({
        emitEvent: false
      });
    }, {
  ...
  removeParseErrorsValidator(control) {
    if (this.parseErrorsValidator) {
      control == null ? void 0 : control.removeValidators(this.parseErrorsValidator);
      control == null ? void 0 : control.updateValueAndValidity({
        emitEvent: false
      });
    }
  }
...
var FormGroup = class extends AbstractControl {
  ...
  contains(controlName) {
    var _a;
    return ((_a = this._find(controlName)) == null ? void 0 : _a.enabled) === true;
  }
...
var _NgForm = class _NgForm extends ControlContainer {
  ...
  removeFormGroup(dir) {
    resolvedPromise$1.then(() => {
      var _a;
      const container = this._findContainer(dir.path);
      (_a = container == null ? void 0 : container.removeControl) == null ? void 0 : _a.call(container, dir.name);
    });
  }
  getFormGroup(dir) {
    return this.form.get(dir.path);
...
var _AbstractFormGroupDirective = class _AbstractFormGroupDirective extends ControlContainer {
  ...
  ngOnDestroy() {
    var _a;
    (_a = this.formDirective) == null ? void 0 : _a.removeFormGroup(this);
  }
  get control() {
...
var _AbstractFormDirective = class _AbstractFormDirective extends ControlContainer {
  ...
  _cleanUpFormContainer(dir) {
    var _a;
    const ctrl = (_a = this.form) == null ? void 0 : _a.get(dir.path);
    if (ctrl) {
  ...
  _updateRegistrations() {
    ...
    (_a = this._oldForm) == null ? void 0 : _a._registerOnCollectionChange(() => {
    });
  }
  _updateValidators() {
...
var _NgModel = class _NgModel extends NgControl {
  constructor(parent, validators, asyncValidators, valueAccessors, _changeDetectorRef, callSetDisabledState, injector, renderer) {
    ...
    __publicField(this, "_ngModelInjector");
  ...
  ngOnChanges(changes) {
    var _a, _b;
    if (!this._registered && (typeof ngDevMode === "undefined" || ngDevMode) && this._parent === null && !((_a = this.options) == null ? void 0 : _a.standalone)) {
      const parentContainer = (_b = this._ngModelInjector) == null ? void 0 : _b.get(ControlContainer, null);
  ...
  ngOnDestroy() {
    var _a;
    (_a = this.formDirective) == null ? void 0 : _a.removeControl(this);
  }
  ...
  _setUpStandalone() {
    if (!this.isCustomControlBased) {
      this.valueAccessor ?? (this.valueAccessor = this.selectedValueAccessor);
...
__publicField(_RadioControlRegistry, "ɵprov", ɵɵdefineService({
...
var _RadioControlValueAccessor = class _RadioControlValueAccessor extends BuiltInControlValueAccessor {
  constructor(renderer, elementRef, _registry, _injector) {
    ...
    __publicField(this, "value");
    __publicField(this, "callSetDisabledState", inject(CALL_SET_DISABLED_STATE, {
      optional: true
  ...
  ngOnChanges(changes) {
    var _a;
    const control = (_a = this._control) == null ? void 0 : _a.control;
...
var _FormArrayName = class _FormArrayName extends ControlContainer {
  ...
  ngOnDestroy() {
    var _a;
    (_a = this.formDirective) == null ? void 0 : _a.removeFormArray(this);
  }
  get control() {
...
var _NgSelectOption = class _NgSelectOption {
  ...
  set value(value) {
    ...
    (_a = this._select) == null ? void 0 : _a._writeValueAfterRender();
  }
  ...
  ngOnDestroy() {
    var _a, _b;
    (_a = this._select) == null ? void 0 : _a._optionMap.delete(this.id);
    (_b = this._select) == null ? void 0 : _b._writeValueAfterRender();
  }
};
...
__publicField(_FormBuilder, "ɵprov", ɵɵdefineService({
  token: _FormBuilder,
...
__publicField(_NonNullableFormBuilder, "ɵprov", ɵɵdefineService({
...
__publicField(_UntypedFormBuilder, "ɵfac", function UntypedFormBuilder_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _UntypedFormBuilder)();
});
__publicField(_UntypedFormBuilder, "ɵprov", ɵɵdefineService({
