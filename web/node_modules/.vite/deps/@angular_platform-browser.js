...
// node_modules/.pnpm/@angular+platform-browser@22.1.4_@angular+animations@22.1.4_@angular+core@22.1.4_@angul_5a2b93837a2194b7f49f2ce512c25885/node_modules/@angular/platform-browser/fesm2022/platform-browser.mjs
var _Meta = class _Meta {
  constructor() {
    __publicField(this, "_doc", inject(DOCUMENT));
    __publicField(this, "_dom", getDOM());
    __publicField(this, "_cachedHead");
  }
  ...
  updateTag(tag, selector) {
    ...
    selector ?? (selector = parseSelector(tag));
...
__publicField(_Meta, "ɵprov", ɵɵdefineService({
  token: _Meta,
  factory: _Meta.ɵfac
}));
var Meta = _Meta;
...
function isMetaTag(tag) {
  return (tag == null ? void 0 : tag.nodeName.toLowerCase()) === "meta";
}
var META_KEYS_MAP = {
...
var _CssVarNamespacer = class _CssVarNamespacer {
  constructor() {
    __publicField(this, "namespacePrefix", inject(CSS_VAR_NAMESPACE, {
      optional: true
    }) ?? "");
  }
  namespace(name) {
...
__publicField(_CssVarNamespacer, "ɵfac", function CssVarNamespacer_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CssVarNamespacer)();
});
__publicField(_CssVarNamespacer, "ɵprov", ɵɵdefineService({
  token: _CssVarNamespacer,
  factory: _CssVarNamespacer.ɵfac
}));
var CssVarNamespacer = _CssVarNamespacer;
(() => {
...
__publicField(_DomSanitizerImpl, "ɵprov", ɵɵdefineService({
